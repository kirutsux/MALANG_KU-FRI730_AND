...
class ToDoList_Adapter(private val context: Context, private val items: MutableList<ToDoListItem>) : BaseAdapter() {
    ...
    private fun showEditDeleteDialog(position: Int) {
        val listItem = filteredItems[position]
        val dialogView = LayoutInflater.from(context).inflate(R.layout.edit_delete_layour, null)
        ...
        editButton.setOnClickListener {
            val editDialogView = LayoutInflater.from(context).inflate(R.layout.edit_layout, null)
